...
namespace Mycom.Target.Unity.Internal.Implementations.iOS
{
    internal class CustomParamsProxy : ICustomParamsProxy
    {
        ...
        {
            MTRGCustomParamsSetEmail(_adId, value == null ? null : String.Join(",", value));
        }

        void ICustomParamsProxy.SetGender(GenderEnum value)
        {
            MTRGCustomParamsSetGender(_adId, (Int32)value);
        }

        void ICustomParamsProxy.SetLang(String value)
        {
            MTRGCustomParamsSetLanguage(_adId, value);
        }

        void ICustomParamsProxy.SetIcqIds(UInt32[] value)
        {
            MTRGCustomParamsSetIcqIds(_adId, value == null ? null : String.Join(",", value.Select(v => Convert.ToString(v)).ToArray()));
        }

        void ICustomParamsProxy.SetMrgsAppId(String value)
        {
            MTRGCustomParamsSetMrgsAppId(_adId, value);
        }

        void ICustomParamsProxy.SetMrgsId(String value)
        {
            MTRGCustomParamsSetMrgsId(_adId, value);
        }

        void ICustomParamsProxy.SetMrgsUserId(String value)
        {
            MTRGCustomParamsSetMrgsUserId(_adId, value);
        }

        void ICustomParamsProxy.SetOkIds(String[] value)
        {
            MTRGCustomParamsSetOkIds(_adId, value == null ? null : String.Join(",", value));
        }

        void ICustomParamsProxy.SetVkIds(String[] value)
        {
            MTRGCustomParamsSetVkIds(_adId, value == null ? null : String.Join(",", value));
        }

        void ICustomParamsProxy.SetCustomParam(String key, String value)
        {
            MTRGCustomParamsSetCustomParam(_adId, key, value);
        }
