...
namespace Mycom.Target.Unity.PlayMode
{
    public partial class CustomParamsInternalAccessor
    {
        ...
        {
            result = _javaCustomParams.GetString("getEmail");
        }
        ...
        {
            var value = _javaCustomParams.GetString("getIcqId");
        ...
        {
            result = _javaCustomParams.GetString("getLang");
        }

        partial void GetMrgsAppId(ref string result)
        {
            result = _javaCustomParams.GetString("getMrgsAppId");
        }

        partial void GetMrgsId(ref string result)
        {
            result = _javaCustomParams.GetString("getMrgsId");
        }

        partial void GetMrgsUserId(ref string result)
        {
            result = _javaCustomParams.GetString("getMrgsUserId");
        }

        partial void GetOkId(ref string result)
        {
            result = _javaCustomParams.GetString("getOkId");
        }
        ...
        {
            result = _javaCustomParams.GetString("getVKId");
        }
